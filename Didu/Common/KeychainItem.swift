...
struct KeychainItem {
    ...
    static func saveUserInKeychain(_ userIdentifier: String) {
        do {
            try KeychainItem(service: XDDevice.bundleId, account: "userIdentifier").saveItem(userIdentifier)
        } catch {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: XDDevice.bundleId, account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: XDDevice.bundleId, account: "userIdentifier").deleteItem()
        } catch {
